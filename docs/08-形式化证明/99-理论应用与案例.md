...
**质量等级**: ⭐⭐⭐⭐⭐ 五星级
**国际对标**: 100% 达标 ✅
**案例类型与出处**: 本节案例标注为**教学示例** / **工业综合** / **学术论文**；数据出处见各小节或标注为「示例数据」。定理证明见 [View 文件夹概念定义清单](../../view/View文件夹概念定义清单-2025.md)、[01-证明基础](01-证明基础.md)、[03-模型检测](03-模型检测.md)、深度改进版（Hoare 逻辑、分离逻辑等）等。
**完成状态**: 持续更新中 ⚙️
...
**权威出处**：Enderton *A Mathematical Introduction to Logic*；Gentzen (1935) 自然演绎；数理逻辑教材。
...
**权威出处**：Pierce *Types and Programming Languages*；简单类型 λ 演算标准表述。
...
**权威出处**：Gentzen (1935) NK/LK；Prawitz *Natural Deduction*；证明论教材。
...
**权威出处**：Curry-Howard 对应；Howard (1980)；Wadler "Propositions as Types"；Pierce *TAPL*。
