...
本文档介绍分布式系统性能优化理论，包括性能指标、优化策略、负载均衡和缓存策略。
...
- [分布式系统性能优化 / Distributed System Performance Optimization](#分布式系统性能优化--distributed-system-performance-optimization)
  ...
  - [1. 性能指标 / Performance Metrics](#1-性能指标--performance-metrics)
  - [2. 优化策略 / Optimization Strategies](#2-优化策略--optimization-strategies)
  - [3. 负载均衡 / Load Balancing](#3-负载均衡--load-balancing)
  - [4. 缓存策略 / Caching Strategies](#4-缓存策略--caching-strategies)
...
### 定义 1.4 (可扩展性 / Scalability)

**可扩展性**是系统在增加资源时性能提升的能力。
