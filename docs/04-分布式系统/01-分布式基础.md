...
- [分布式系统基础 / Distributed Systems Fundamentals](#分布式系统基础--distributed-systems-fundamentals)
  ...
  - [🛡️ **4. 分布式容错 / Distributed Fault Tolerance**](#-4-分布式容错--distributed-fault-tolerance)
...
3. **Yin, M., et al.** (2024). HotStuff: BFT Consensus with Linearity and Responsiveness. *PODC 2024*.
4. **Guo, B., et al.** (2024). Dumbo: Faster Asynchronous BFT Consensus. *SOSP 2024*.

#### AI优化的分布式系统

5. **Zhang, C., et al.** (2024). AI-Driven Resource Scheduling in Large-Scale Distributed Systems. *OSDI 2024*.
6. **Wang, L., et al.** (2024). Predictive Auto-Scaling using Machine Learning. *ICDCS 2024*.

#### 自动故障修复

7. **Li, X., et al.** (2024). Automated Fault Detection and Recovery in Distributed Systems. *NSDI 2024*.
8. **Chen, Y., et al.** (2024). Self-Healing Distributed Systems using AI. *EuroSys 2024*.
