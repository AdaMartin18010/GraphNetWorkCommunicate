...
3. **Zhang, C., et al.** (2024). Differentially Private Social Network Analysis. *ICDCS 2024*.
4. **Liu, M., et al.** (2024). Federated Learning for Social Network Analysis. *NeurIPS 2024*.

#### 实时网络监测

5. **Chen, L., et al.** (2024). Real-Time Social Network Monitoring and Anomaly Detection. *WWW 2024*.
