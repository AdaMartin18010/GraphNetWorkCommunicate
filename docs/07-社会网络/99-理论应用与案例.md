...
**质量等级**: ⭐⭐⭐⭐⭐ 五星级
**国际对标**: 100% 达标 ✅
**案例类型与出处**: 本节案例标注为**教学示例** / **工业综合** / **学术论文**；数据出处见各小节或标注为「示例数据」。定理证明见 [思维表征工具集合-社会网络定义树与定理树-完整版-2025](思维表征工具集合-社会网络定义树与定理树-完整版-2025.md)、[01-社会网络基础](01-社会网络基础.md)、[02-网络分析](02-网络分析.md) 等。
**完成状态**: 持续更新中 ⚙️
...
**权威出处**：DeGroot (1974)；社会网络分析教材（Easley & Kleinberg）。
...
**权威出处**：Kermack & McKendrick (1927)；流行病学与网络传播教材（Newman, *Networks*）。
...
**权威出处**：Watts & Strogatz (1998), *Nature*；Newman, *Networks*；社会网络分析教材。
...
**权威出处**：Barabási & Albert (1999)；Newman, *Networks*；无标度网络教材。
...
**权威出处**：Louvain — Blondel et al. (2008), *J. Stat. Mech.*；模块度 — Newman & Girvan (2004)；Fortunato (2010) 综述。
...
- [社会网络基础](01-社会网络基础.md) - 理解理论基础
- [网络分析](02-网络分析.md) - 理解分析方法
