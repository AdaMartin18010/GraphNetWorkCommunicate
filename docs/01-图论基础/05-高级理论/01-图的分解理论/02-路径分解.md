...
本文档介绍图论中的路径分解（Path Decomposition）理论，包括路径分解的定义、路径宽的概念和算法实现。

---

## 📑 **目录 / Table of Contents**

- [路径分解 / Path Decomposition](#路径分解--path-decomposition)
  - [📚 **概述 / Overview**](#-概述--overview)
  - [📑 **目录 / Table of Contents**](#-目录--table-of-contents)
  - [📐 **形式化定义 / Formal Definition**](#-形式化定义--formal-definition)
    - [定义 5.1.3 (路径分解 / Path Decomposition)](#定义-513-路径分解--path-decomposition)
    - [定义 5.1.4 (路径宽 / Pathwidth)](#定义-514-路径宽--pathwidth)
  - [🔧 **性质 / Properties**](#-性质--properties)
  - [💻 **算法实现 / Algorithm Implementation**](#-算法实现--algorithm-implementation)
    - [算法 5.1.2 (路径分解构建 - 简化版)](#算法-512-路径分解构建---简化版)
