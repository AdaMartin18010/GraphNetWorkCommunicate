...
- [Turán定理的详细证明 / Detailed Proof of Turán's Theorem](#turán定理的详细证明--detailed-proof-of-turáns-theorem)
  ...
  - [📐 **定理表述 / Theorem Statement**](#-定理表述--theorem-statement)
    - [定理 5.4.1 (Turán定理 / Turán's Theorem)](#定理-541-turán定理--turáns-theorem)
    - [定义 5.4.1 (Turán图 / Turán Graph)](#定义-541-turán图--turán-graph)
  - [🔬 **完整证明 / Complete Proof**](#-完整证明--complete-proof)
    - [步骤 1：证明 $T\_{r,n}$ 的边数](#步骤-1证明-t_rn-的边数)
    - [步骤 2：证明 $T\_{r,n}$ 不包含 $K\_{r+1}$](#步骤-2证明-t_rn-不包含-k_r1)
    - [步骤 3：证明任何不包含 $K\_{r+1}$ 的图 $G$ 的边数不超过 $|E(T\_{r,n})|$](#步骤-3证明任何不包含-k_r1-的图-g-的边数不超过-et_rn)
    - [步骤 4：结论](#步骤-4结论)
