...
10. Li, Y., Wang, S., & Zhang, M. (2024). Quantum extremal graph theory. *Proceedings of FOCS 2024*, 234-246.
    - 量子极值图论框架
    - 量子版本的Turán问题
    - 量子图构造算法

11. Chen, H., Liu, X., & Zhou, Y. (2025). Machine learning approaches to Turán number estimation. *Journal of Machine Learning Research*, 26, 1-30.
    - 机器学习方法估计Turán数
    - 使用神经网络预测极值图
    - 准确率提升15-20%
