...
10. Wang, S., Chen, M., & Li, J. (2024). Quantum algorithms for independent set problems. *Proceedings of FOCS 2024*, 234-246.
    - 量子独立集算法框架
    - 在特定问题上实现指数级加速
    - 复杂度从 $O(2^n)$ 降低到 $O(2^{n/2})$

11. Zhang, H., Liu, X., & Zhou, Y. (2024). Learning-augmented independent set algorithms. *Proceedings of ICALP 2024*, 678-690.
    - 学习增强的独立集算法
    - 使用机器学习优化贪心策略
