# 加权匹配算法 / Weighted Matching Algorithms

## 📚 **概述 / Overview**

本文档介绍带权二分图中的加权匹配算法，主要是Kuhn-Munkres算法（KM算法）。

---

## 📑 **目录 / Table of Contents**

- [加权匹配算法 / Weighted Matching Algorithms](#加权匹配算法--weighted-matching-algorithms)
  - [📚 **概述 / Overview**](#-概述--overview)
  - [📑 **目录 / Table of Contents**](#-目录--table-of-contents)
  - [💻 **算法实现 / Algorithm Implementation**](#-算法实现--algorithm-implementation)
    - [算法 5.3.3 (Kuhn-Munkres算法 / KM算法)](#算法-533-kuhn-munkres算法--km算法)
...
**权威出处与复杂度标准**：Kuhn-Munkres（KM）算法 $O(V^3)$ — Kuhn (1955), Munkres (1957)；CLRS *Introduction to Algorithms*；Diestel *Graph Theory*；MIT 18.217 图论课程。
