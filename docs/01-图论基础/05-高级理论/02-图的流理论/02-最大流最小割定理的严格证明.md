...
- [最大流最小割定理的严格证明 / Strict Proof of Max-Flow Min-Cut Theorem](#最大流最小割定理的严格证明--strict-proof-of-max-flow-min-cut-theorem)
  ...
  - [📐 **定理表述 / Theorem Statement**](#-定理表述--theorem-statement)
    - [定理 5.2.1 (最大流最小割定理 / Max-Flow Min-Cut Theorem)](#定理-521-最大流最小割定理--max-flow-min-cut-theorem)
...
**权威出处**：Ford & Fulkerson (1956)；Diestel, *Graph Theory*；CLRS *Introduction to Algorithms* Ch.26；证明详见 [02-连通性](../../02-连通性.md) 第7.2节或本目录 [05-流算法证明树](05-流算法证明树.md)。
