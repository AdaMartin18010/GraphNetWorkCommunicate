...
- [多商品流理论 / Multi-Commodity Flow Theory](#多商品流理论--multi-commodity-flow-theory)
  ...
  - [1. 形式化定义 / Formal Definition](#1-形式化定义--formal-definition)
    - [定义 1.1 (多商品流网络 / Multi-Commodity Flow Network)](#定义-11-多商品流网络--multi-commodity-flow-network)
    - [定义 1.2 (多商品流 / Multi-Commodity Flow)](#定义-12-多商品流--multi-commodity-flow)
    - [定义 1.3 (多商品流可行性 / Multi-Commodity Flow Feasibility)](#定义-13-多商品流可行性--multi-commodity-flow-feasibility)
  - [2. 算法实现 / Algorithm Implementation](#2-算法实现--algorithm-implementation)
    - [算法 2.1 (多商品流可行性检查 - 线性规划方法)](#算法-21-多商品流可行性检查---线性规划方法)
  - [3. 复杂度分析 / Complexity Analysis](#3-复杂度分析--complexity-analysis)
    - [定理 3.1 (多商品流问题复杂度)](#定理-31-多商品流问题复杂度)
    - [特殊情况](#特殊情况)
