# 分布式系统应用模式工具集成指南 / Distributed Systems Tools Integration Guide

## 📚 **概述 / Overview**

**文档目的**: 提供分布式系统领域应用模式的完整工具集成指南，包括Petri网、动态图论、拓扑模型相关工具的安装、配置、集成和使用方法。
...
| 场景 | 推荐工具 | 理由 |
|------|----------|------|
| 协议验证 | TLA+ / CPN Tools | 形式化验证 |
| 分布式追踪 | Jaeger / Zipkin | 完整调用链 |
| 服务依赖 | Neo4j | 复杂查询 |
| 监控 | Prometheus | 时间序列数据 |
