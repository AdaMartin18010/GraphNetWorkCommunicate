...
- ✅ `01-Petri网公理体系梳理.md`（已完成）
- ✅ `01-Petri网定理证明树.md`（已完成）

### 6.2 后续细化

- ✅ 定理证明树已完成：可达性、活性、有界性、声音性、不变量
- ✅ 典型场景示例已完成：死锁预防、副本拓扑监控、分布漂移检测（参见典型场景详细示例补充.md）
- 后续可补充：工作流网、生产者-消费者、互斥锁、两阶段提交的详细案例
- 后续可补充：CPN Tools状态空间；TLA+/Promela对照的工具示例
