...
本文档介绍协议合成理论，包括协议合成的定义、合成方法、合成算法和应用场景。
...
- [协议合成理论 / Protocol Synthesis Theory](#协议合成理论--protocol-synthesis-theory)
  - [📚 **概述 / Overview**](#-概述--overview)
  - [📑 **目录 / Table of Contents**](#-目录--table-of-contents)
  - [1. 形式化定义 / Formal Definition](#1-形式化定义--formal-definition)
  - [2. 合成方法 / Synthesis Methods](#2-合成方法--synthesis-methods)
  - [3. 合成算法 / Synthesis Algorithms](#3-合成算法--synthesis-algorithms)
...
### 定义 1.1 (协议合成 / Protocol Synthesis)
