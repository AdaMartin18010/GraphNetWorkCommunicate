# 协议正确性的形式化规范 / 协议正确性的形式化规范

## 📚 **概述 / Overview**

本文档介绍协议正确性的形式化规范的详细理论和实现。
...
- [协议正确性的形式化规范 / 协议正确性的形式化规范](#协议正确性的形式化规范--协议正确性的形式化规范)
  - [📚 **概述 / Overview**](#-概述--overview)
  - [📑 **目录 / Table of Contents**](#-目录--table-of-contents)
  - [协议正确性的形式化规范](#协议正确性的形式化规范)
  - [🔬 **协议正确性规范的形式化语义 / Formal Semantics of Protocol Correctness Specifications**](#-协议正确性规范的形式化语义--formal-semantics-of-protocol-correctness-specifications)
    - [定义 6.1.4.1 (安全性形式化语义 / Formal Semantics of Safety)](#定义-6141-安全性形式化语义--formal-semantics-of-safety)
    - [定义 6.1.4.2 (活性形式化语义 / Formal Semantics of Liveness)](#定义-6142-活性形式化语义--formal-semantics-of-liveness)
    - [定义 6.1.4.3 (公平性形式化语义 / Formal Semantics of Fairness)](#定义-6143-公平性形式化语义--formal-semantics-of-fairness)
  - [🔬 **协议规范验证的形式化框架 / Formal Framework for Protocol Specification Verification**](#-协议规范验证的形式化框架--formal-framework-for-protocol-specification-verification)
    - [定理 6.1.4.1 (安全性验证框架 / Safety Verification Framework)](#定理-6141-安全性验证框架--safety-verification-framework)
    - [证明 / Proof](#证明--proof)
      - [步骤1: 充分性 / Step 1: Sufficiency](#步骤1-充分性--step-1-sufficiency)
      - [步骤2: 必要性 / Step 2: Necessity](#步骤2-必要性--step-2-necessity)
      - [步骤3: 结论 / Step 3: Conclusion](#步骤3-结论--step-3-conclusion)
    - [定理 6.1.4.2 (活性验证框架 / Liveness Verification Framework)](#定理-6142-活性验证框架--liveness-verification-framework)
    - [证明 / Proof](#证明--proof-1)
      - [步骤1: 充分性 / Step 1: Sufficiency](#步骤1-充分性--step-1-sufficiency-1)
      - [步骤2: 必要性 / Step 2: Necessity](#步骤2-必要性--step-2-necessity-1)
