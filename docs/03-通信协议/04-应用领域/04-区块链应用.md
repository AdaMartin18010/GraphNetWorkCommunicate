...
- [区块链应用 / Blockchain Applications](#区块链应用--blockchain-applications)
  ...
  - [📐 **形式化定义 / Formal Definition**](#-形式化定义--formal-definition)
    - [定义 4.4.1 (区块链网络 / Blockchain Network)](#定义-441-区块链网络--blockchain-network)
    - [定义 4.4.2 (共识达成 / Consensus Achievement)](#定义-442-共识达成--consensus-achievement)
  - [🔧 **核心协议 / Core Protocols**](#-核心协议--core-protocols)
    - [4.4.1 Bitcoin协议 / Bitcoin Protocol](#441-bitcoin协议--bitcoin-protocol)
    - [4.4.2 Ethereum协议 / Ethereum Protocol](#442-ethereum协议--ethereum-protocol)
    - [4.4.3 Polkadot协议 / Polkadot Protocol](#443-polkadot协议--polkadot-protocol)
  - [💼 **应用案例 / Application Cases**](#-应用案例--application-cases)
    - [案例1: Bitcoin网络优化](#案例1-bitcoin网络优化)
    - [案例2: Ethereum 2.0信标链](#案例2-ethereum-20信标链)
  - [💻 **算法实现 / Algorithm Implementation**](#-算法实现--algorithm-implementation)
    - [4.4.1 P2P节点发现 / P2P Node Discovery](#441-p2p节点发现--p2p-node-discovery)
  - [📊 **性能评估 / Performance Evaluation**](#-性能评估--performance-evaluation)
    - [4.4.1 区块链协议性能对比](#441-区块链协议性能对比)
