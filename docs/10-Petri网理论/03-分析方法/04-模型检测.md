...
- [模型检测 / Model Checking](#模型检测--model-checking)
  ...
  - [1. 模型检测基础 / Model Checking Fundamentals](#1-模型检测基础--model-checking-fundamentals)
    - [1.1 模型检测的定义 / Definition of Model Checking](#11-模型检测的定义--definition-of-model-checking)
    - [1.2 模型检测的优势 / Advantages of Model Checking](#12-模型检测的优势--advantages-of-model-checking)
    - [1.3 模型检测的挑战 / Challenges of Model Checking](#13-模型检测的挑战--challenges-of-model-checking)
  - [2. 时态逻辑 / Temporal Logic](#2-时态逻辑--temporal-logic)
    - [2.1 线性时态逻辑（LTL）/ Linear Temporal Logic](#21-线性时态逻辑ltl-linear-temporal-logic)
      - [2.1.1 LTL语法 / LTL Syntax](#211-ltl语法--ltl-syntax)
      - [2.1.2 LTL语义 / LTL Semantics](#212-ltl语义--ltl-semantics)
      - [2.1.3 LTL示例 / LTL Examples](#213-ltl示例--ltl-examples)
    - [2.2 计算树逻辑（CTL）/ Computation Tree Logic](#22-计算树逻辑ctl-computation-tree-logic)
      - [2.2.1 CTL语法 / CTL Syntax](#221-ctl语法--ctl-syntax)
      - [2.2.2 CTL与LTL的区别 / Difference Between CTL and LTL](#222-ctl与ltl的区别--difference-between-ctl-and-ltl)
    - [2.3 CTL*逻辑 / CTL* Logic](#23-ctl逻辑--ctl-logic)
  - [3. Petri网模型检测方法 / Petri Net Model Checking Methods](#3-petri网模型检测方法--petri-net-model-checking-methods)
    - [3.1 可达性图构造 / Reachability Graph Construction](#31-可达性图构造--reachability-graph-construction)
    - [3.2 LTL模型检测算法 / LTL Model Checking Algorithm](#32-ltl模型检测算法--ltl-model-checking-algorithm)
      - [3.2.1 自动机方法 / Automata Method](#321-自动机方法--automata-method)
      - [3.2.2 嵌套深度优先搜索 / Nested Depth-First Search](#322-嵌套深度优先搜索--nested-depth-first-search)
    - [3.3 CTL模型检测算法 / CTL Model Checking Algorithm](#33-ctl模型检测算法--ctl-model-checking-algorithm)
      - [3.3.1 标记算法 / Labeling Algorithm](#331-标记算法--labeling-algorithm)
  - [4. 模型检测工具 / Model Checking Tools](#4-模型检测工具--model-checking-tools)
    ...
    - [4.3 SPIN](#43-spin)
    - [4.4 NuSMV](#44-nusmv)
    - [4.5 工具选择指南 / Tool Selection Guide](#45-工具选择指南--tool-selection-guide)
      - [4.5.1 工具对比表](#451-工具对比表)
      - [4.5.2 场景选择指南](#452-场景选择指南)
      - [4.5.3 工具组合使用建议](#453-工具组合使用建议)
      - [4.5.4 性能基准测试](#454-性能基准测试)
      - [4.5.5 学习路径建议](#455-学习路径建议)
      - [4.5.6 常见问题解答](#456-常见问题解答)
  - [5. 实际应用案例 / Practical Application Cases](#5-实际应用案例--practical-application-cases)
    - [5.1 案例1：协议安全性验证 / Case 1: Protocol Safety Verification](#51-案例1协议安全性验证--case-1-protocol-safety-verification)
    - [5.2 案例2：工作流活性验证 / Case 2: Workflow Liveness Verification](#52-案例2工作流活性验证--case-2-workflow-liveness-verification)
    - [5.3 案例3：制造系统公平性验证 / Case 3: Manufacturing System Fairness Verification](#53-案例3制造系统公平性验证--case-3-manufacturing-system-fairness-verification)
  - [6. 算法实现完善与性能优化 / Algorithm Implementation Enhancement and Performance Optimization](#6-算法实现完善与性能优化--algorithm-implementation-enhancement-and-performance-optimization)
    - [6.1 完整LTL模型检测算法实现](#61-完整ltl模型检测算法实现)
      - [算法 6.1 (完整LTL到Büchi自动机转换 / Complete LTL to Büchi Automaton Conversion)](#算法-61-完整ltl到büchi自动机转换--complete-ltl-to-büchi-automaton-conversion)
    - [6.2 符号模型检测算法](#62-符号模型检测算法)
      - [算法 6.2 (符号模型检测 / Symbolic Model Checking)](#算法-62-符号模型检测--symbolic-model-checking)
    - [6.3 性能评估与优化](#63-性能评估与优化)
      - [6.3.1 算法性能对比](#631-算法性能对比)
      - [6.3.2 实际性能基准](#632-实际性能基准)
      - [6.3.3 优化技术](#633-优化技术)
  - [7. 最新研究进展（2024-2025）/ Latest Research Progress (2024-2025)](#7-最新研究进展2024-2025-latest-research-progress-2024-2025)
    - [7.1 机器学习增强的模型检测](#71-机器学习增强的模型检测)
    - [7.2 实时模型检测](#72-实时模型检测)
    - [7.3 量子模型检测](#73-量子模型检测)
