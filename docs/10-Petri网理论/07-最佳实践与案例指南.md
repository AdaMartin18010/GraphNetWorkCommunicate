...
**案例类型与出处**: 本节案例标注为**教学示例** / **工业综合** / **学术论文**；数据出处见各小节或标注为「示例数据」。定理与推理结构见 [03-分析方法](03-分析方法/README.md)、[05-应用领域](05-应用领域/README.md)、[View 文件夹思维表征工具集-2025](../../view/View文件夹思维表征工具集-2025.md) 中 Petri 网决策树与对比矩阵。

**权威出处**：Petri 网形式化 — Petri (1962)；可达性/有界性/活性 — Reisig *Understanding Petri Nets*、Murata (1989) 综述；覆盖图与符号方法 — 模型检测与形式化验证教材（Clarke et al.）。
...
本节各步骤下的清单为**实践自检项**，在具体建模项目中可逐项勾选。
