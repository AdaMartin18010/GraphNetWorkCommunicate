...
- [工作流建模 / Workflow Modeling](#工作流建模--workflow-modeling)
  ...
  - [1. 工作流建模方法 / Workflow Modeling Methods](#1-工作流建模方法--workflow-modeling-methods)
    ...
    - [1.2 建模步骤 / Modeling Steps](#12-建模步骤--modeling-steps)
    - [1.3 建模示例 / Modeling Example](#13-建模示例--modeling-example)
  - [2. 与BPMN的对比 / Comparison with BPMN](#2-与bpmn的对比--comparison-with-bpmn)
    - [2.1 BPMN简介 / BPMN Introduction](#21-bpmn简介--bpmn-introduction)
    - [2.2 Petri网 vs BPMN / Petri Net vs BPMN](#22-petri网-vs-bpmn--petri-net-vs-bpmn)
    - [2.3 转换方法 / Transformation Methods](#23-转换方法--transformation-methods)
  - [3. 工作流模式 / Workflow Patterns](#3-工作流模式--workflow-patterns)
    - [3.1 基本模式 / Basic Patterns](#31-基本模式--basic-patterns)
      - [3.1.1 顺序模式 / Sequential Pattern](#311-顺序模式--sequential-pattern)
      - [3.1.2 并行模式 / Parallel Pattern](#312-并行模式--parallel-pattern)
      - [3.1.3 选择模式 / Choice Pattern](#313-选择模式--choice-pattern)
    - [3.2 高级模式 / Advanced Patterns](#32-高级模式--advanced-patterns)
      - [3.2.1 循环模式 / Loop Pattern](#321-循环模式--loop-pattern)
      - [3.2.2 同步合并模式 / Synchronization Merge Pattern](#322-同步合并模式--synchronization-merge-pattern)
  - [4. 实际应用案例 / Practical Application Cases](#4-实际应用案例--practical-application-cases)
    - [4.1 案例1：企业订单处理流程 / Case 1: Enterprise Order Processing Workflow](#41-案例1企业订单处理流程--case-1-enterprise-order-processing-workflow)
    - [4.2 案例2：医院患者就诊流程 / Case 2: Hospital Patient Visit Workflow](#42-案例2医院患者就诊流程--case-2-hospital-patient-visit-workflow)
    - [4.3 案例3：软件开发流程 / Case 3: Software Development Workflow](#43-案例3软件开发流程--case-3-software-development-workflow)
  - [5. 工作流验证与优化 / Workflow Verification and Optimization](#5-工作流验证与优化--workflow-verification-and-optimization)
    - [5.1 工作流验证 / Workflow Verification](#51-工作流验证--workflow-verification)
      - [5.1.1 可达性验证 / Reachability Verification](#511-可达性验证--reachability-verification)
      - [5.1.2 死锁检测 / Deadlock Detection](#512-死锁检测--deadlock-detection)
      - [5.1.3 活性验证 / Liveness Verification](#513-活性验证--liveness-verification)
    - [5.2 工作流优化 / Workflow Optimization](#52-工作流优化--workflow-optimization)
      - [5.2.1 性能优化 / Performance Optimization](#521-性能优化--performance-optimization)
      - [5.2.2 成本优化 / Cost Optimization](#522-成本优化--cost-optimization)
      - [5.2.3 质量优化 / Quality Optimization](#523-质量优化--quality-optimization)
    - [5.3 工作流挖掘 / Workflow Mining](#53-工作流挖掘--workflow-mining)
