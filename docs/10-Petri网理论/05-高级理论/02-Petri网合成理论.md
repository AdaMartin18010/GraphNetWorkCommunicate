...
- [Petri网合成理论 / Petri Net Synthesis Theory](#petri网合成理论--petri-net-synthesis-theory)
  ...
  - [1. 形式化定义 / Formal Definition](#1-形式化定义--formal-definition)
    - [定义 1.1 (Petri网合成 / Petri Net Synthesis)](#定义-11-petri网合成--petri-net-synthesis)
    - [定义 1.2 (合成操作 / Synthesis Operations)](#定义-12-合成操作--synthesis-operations)
  - [2. 合成方法 / Synthesis Methods](#2-合成方法--synthesis-methods)
    - [2.1 并行合成](#21-并行合成)
    - [2.2 顺序合成](#22-顺序合成)
    - [算法 2.1 (Petri网合成)](#算法-21-petri网合成)
  - [3. 合成规则 / Synthesis Rules](#3-合成规则--synthesis-rules)
    - [规则 3.1 (模块化合成规则)](#规则-31-模块化合成规则)
    - [规则 3.2 (层次合成规则)](#规则-32-层次合成规则)
  - [4. 应用场景 / Application Scenarios](#4-应用场景--application-scenarios)
    - [4.1 工作流系统设计](#41-工作流系统设计)
    - [4.2 协议设计](#42-协议设计)
...
**改进内容**: 添加4个详细工程应用案例（FMS、CPS、生物网络、分布式系统），添加最新研究进展，文档字数从约260字增加到约7000字（增长27倍）
