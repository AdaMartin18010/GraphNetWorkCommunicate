...
- [不变式计算算法 / Invariant Computation Algorithm](#不变式计算算法--invariant-computation-algorithm)
  ...
  - [📊 **数学原理 / Mathematical Principles**](#-数学原理--mathematical-principles)
    - [S-不变量（P-不变量）/ S-Invariant (P-Invariant)](#s-不变量p-不变量-s-invariant-p-invariant)
      - [定义](#定义)
      - [性质](#性质)
      - [计算方法](#计算方法)
      - [应用](#应用)
    - [T-不变量 / T-Invariant](#t-不变量--t-invariant)
      - [定义](#定义-1)
      - [性质](#性质-1)
      - [计算方法](#计算方法-1)
      - [应用](#应用-1)
  ...
  - [📝 **应用示例 / Application Examples**](#-应用示例--application-examples)
    - [示例1：生产者-消费者系统的S-不变量](#示例1生产者-消费者系统的s-不变量)
    - [示例2：循环系统的T-不变量](#示例2循环系统的t-不变量)
    - [示例3：使用代码计算不变式](#示例3使用代码计算不变式)
  - [🔬 **测试用例 / Test Cases**](#-测试用例--test-cases)
    - [测试用例1：简单循环网](#测试用例1简单循环网)
    - [测试用例2：资源竞争网](#测试用例2资源竞争网)
