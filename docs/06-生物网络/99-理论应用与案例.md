...
**概念矩阵与决策树**：见 [06-生物网络 README](README.md) 思维表征工具集合及 [View 对比矩阵集-2025](../../view/View文件夹对比矩阵集-2025.md)。
...
**权威出处**：Hodgkin & Huxley (1952), *J. Physiol.*；计算神经科学教材（Dayan & Abbott）。
...
**权威出处**：Lyapunov 稳定性理论；Khalil *Nonlinear Systems*；动力系统教材。
...
**权威出处**：Hill 方程；Alon *An Introduction to Systems Biology*；基因调控网络教材。
...
**权威出处**：Milo et al. (2002), *Science* 网络模体；Alon *An Introduction to Systems Biology*；Shen-Orr et al. 前馈环。
